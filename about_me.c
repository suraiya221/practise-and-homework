...
int main(){
    ...
    printf("Major\t\t       | Mechanical Engineering \t\t     Experience\t\t |00000000 00000000 00000000 00001111\n");
    ...
    printf("Major\t\t       |Computer Engineering\t\t   Experience\t\t       |00000000 00000000 00000000 00000010 \n");
    ...
    printf("Major\t\t       |Electronic Engineering\t\t  Experience\t\t       |00000000 00000000 00000000 00000001\n");
